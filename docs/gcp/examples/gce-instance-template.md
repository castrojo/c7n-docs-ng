...
Custodian can delete Instance Templates whose settings do not match the
requirements.

In the example below, the policy checks if there are instance templates
whose `machineType` setting is among the `disallowed-machine-types`.
