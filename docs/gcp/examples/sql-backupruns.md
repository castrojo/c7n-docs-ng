...
The following example demonstrates ability of Cloud Custodian to track
backup runs of Cloud SQL instances and list unsuccessful backups (if
any) older than 5 days.
